...
const APP_SHELL = [
  ...
  '/design-system/css/gradient-themes.css',
  '/design-system/css/typography.css',
  '/js/workspace-nav.js',
  '/design-system/appearance/gradient-theme-sync.js',
  '/design-system/appearance/boot.js'
];
...
function isCacheableAsset(url) {
  ...
  if (url.pathname === '/core/identity/client.js' || url.pathname.endsWith('/client.js') && url.pathname.includes('/identity/')) return false;
